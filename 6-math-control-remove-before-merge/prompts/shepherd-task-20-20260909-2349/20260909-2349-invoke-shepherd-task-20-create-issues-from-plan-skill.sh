#!/usr/bin/env bash
set -euo pipefail
timestamp=20260909-2349
log_dir_full=/home/edburns/workareas/dd-3061974-01-bash-shepherd-control/6-math-control-remove-before-merge/prompts/shepherd-task-20-20260909-2349
...
prompt_file=/home/edburns/workareas/dd-3061974-01-bash-shepherd-control/6-math-control-remove-before-merge/prompts/shepherd-task-20-20260909-2349/20260909-2349-invoke-shepherd-task-20-create-issues-from-plan-skill.md
